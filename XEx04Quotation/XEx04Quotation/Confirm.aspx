        ...
        <main class="container">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <%-- buttons go here --%>
                    <asp:Label ID="lblQuotationSend" runat="server" BackColor="#66CCFF" BorderStyle="None" BorderWidth="1px" CssClass="alert" Text="Quotation sent to at ." Visible="False"></asp:Label>
                    <asp:Button ID="btnSendQuotation" runat="server" Text="Send Quotation"
                         CssClass="btn btn-primary" OnClic="btnSendClick" OnClick="btnSendQuotation_Click" />
            ...
            <div class="form-group">
                <div class="col-sm-offset-1 col-sm-11">
                    ...
                    <asp:Label ID="lblMessage" runat="server" CssClass="text-info">
                        Click the Send Quotation button to send the quotation via email
                    </asp:Label>
                </div>
            </div>
