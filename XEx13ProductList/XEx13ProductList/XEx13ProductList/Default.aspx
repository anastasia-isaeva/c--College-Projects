            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-offset-1 col-sm-10">
                    <asp:DataList ID="dlProducts" runat="server" 
                        ...
                        CssClass="table table-bordered table-striped table-condensed" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" OnSelectedIndexChanged="dlProducts_SelectedIndexChanged" Width="1048px">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>  
                            ...
                            <asp:Label ID="lblTotal" runat="server"
                                Text='<%# Eval("Total") %>' CssClass="col-xs-3 text-right" />
                        </ItemTemplate>
                        <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                        <HeaderStyle CssClass="bg-halloween" BackColor="#333333" Font-Bold="True" ForeColor="White" />
